    ...
    kannadaSections: [
      {
        ...
        items: [
          ...
          "ಪಂದ್ಯಾವಳಿಯ ಸಮಯದಲ್ಲಿ ಆಟಗಾರರಿಗೆ ಸಂಭವಿಸುವ ಅಪಘಾತ, ಗಾಯ ಅಥವಾ ಇತರ ಅನಾಹುತಗಳಿಗೆ DKPL ತಂಡ ಮಾಲೀಕರು ಮತ್ತು ಆಯೋಜಕರು ಜವಾಬ್ದಾರರಲ್ಲ. ಪ್ರತಿ ಆಟಗಾರ ತಮ್ಮ ಸ್ವಂತ ಅಪಾಯದಲ್ಲಿ ಪಾಲ್ಗೊಳ್ಳುತ್ತಾರೆ.",
          "ಅಧಿಕೃತ ವೆಬ್‌ಸೈಟ್‌ನಲ್ಲಿ ತಂಡದ ಪಟ್ಟಿಯಲ್ಲಿ ನಮೂದಿಸಿದ ಆಟಗಾರರು ಮಾತ್ರ ಆಡಬಹುದು. ಆಯೋಜಕ ಸಮಿತಿಯ ಬರಹದ ಮಂಜೂರಿ ಇಲ್ಲದೆ ಅತಿಥಿ ಅಥವಾ ನೋಂದಾಯಿತವಲ್ಲದ ಆಟಗಾರರು ಮೈದಾನಕ್ಕೆ ಇಳಿಯಲು ಸಾಧ್ಯವಿಲ್ಲ.",
          "ಪಂದ್ಯದ ದಿನ ನ್ಯಾಯಾಧೀಶರು ಮತ್ತು ಕ್ಯಾಪ್ಟನ್‌ಗಳು (ಟಾಸ್, ಆಟಗಾರರ ಪಟ್ಟಿ, ಮೈದಾನದ ವಿವಾದಗಳು) ತೆಗೆದ ನಿರ್ಧಾರಗಳು, ಸಮಿತಿಯ ಬರಹದ ಪುನರ್ ಪರಿಶೀಲನೆ ಇಲ್ಲದೆ, ಆ ಪಂದ್ಯಕ್ಕೆ ಅಂತಿಮ.",
          "ಹವಾಮಾನ, ಮೈದಾನದ ಸ್ಥಿತಿ ಅಥವಾ ಸುರಕ್ಷತೆ ಕಾರಣಗಳಿಗಾಗಿ ಆಯೋಜಕ ಸಮಿತಿ ಪಂದ್ಯಗಳನ್ನು ಮರುನಿಗದಿ ಮಾಡಬಹುದು. ಬದಲಾವಣೆಗಳನ್ನು ಸಾಧ್ಯವಾದಾಗ ಈ ವೆಬ್‌ಸೈಟ್‌ನಲ್ಲಿ ಹಂಚಲಾಗುತ್ತದೆ."
        ]
      },
      {
        title: "ವಸ್ತ್ರ ಧೋರಣೆ (Dress code)",
        items: [
          "ಪ್ರತಿ ಪಂದ್ಯಕ್ಕೂ ಪ್ರತಿ ಆಟಗಾರರಿಗೆ ವಸ್ತ್ರ ಧೋರಣೆ ಅನಿವಾರ್ಯ.",
          "ಅಧಿಕೃತ ತಂಡ ಜರ್ಸಿ ಮತ್ತು ತಂಡ ಪ್ಯಾಂಟ್ ಕಡ್ಡಾಯ. ಪೂರ್ಣ ತಂಡ ಕಿಟ್ ಇಲ್ಲದ ಆಟಗಾರರನ್ನು ಅಂಪೈರ್‌ಗಳ (Umpires) ಅಥವಾ ಸಮಿತಿ ಮೈದಾನಕ್ಕೆ ಇಳಿಯಲು ನಿರಾಕರಿಸಬಹುದು."
        ]
      },
      {
        title: "ಗಾಯ, ಬದಲಿ ಮತ್ತು ತಂಡದ ಲಭ್ಯತೆ",
        items: [
          "ಬದಲಿ ಫೀಲ್ಡರ್ ಅಥವಾ ಬ್ಯಾಟರ್‌ಗೆ ಬದಲಿ ಓಟಗಾರ ಇರುವುದಿಲ್ಲ. ಗಾಯಗೊಂಡ ಬ್ಯಾಟರ್‌ಗೆ ಬದಲಿ ಓಟಗಾರನ (Substitute Runner) ಅನುಮತಿ ಇರುವುದಿಲ್ಲ. ಬ್ಯಾಟರ್ (Retired Hurt) ಆಗಬೇಕು ಅಥವಾ ಸ್ವತಃ ಆಟವನ್ನು ಮುಂದುವರಿಸಬಹುದು. ಅಂತಿಮ ನಿರ್ಧಾರ ಅಂಪೈರ್‌ಗಳ (Umpires) ವಿವೇಚನೆಗೆ ಒಳಪಟ್ಟಿರುತ್ತದೆ. 🏏✅",
          "ಕೆಲವು ಆಟಗಾರರು ಬಂದಿಲ್ಲದಿದ್ದರೂ ಹಾಜರಿರುವವರೊಂದಿಗೆ ತಂಡ ಆಡಬೇಕು (ಉದಾ. 9 ಅಥವಾ 10 ಆಟಗಾರರು).",
          "ನೋಂದಾಯಿತ ತಂಡ ಪಟ್ಟಿಯಲ್ಲಿ 3 ಕ್ಕಿಂತ ಹೆಚ್ಚು ಆಟಗಾರರು ಲಭ್ಯವಿಲ್ಲದಿದ್ದರೆ ಆ ತಂಡ ಪಂದ್ಯ ಆಡಲು ಅರ್ಹವಲ್ಲ. ಎದುರಾಳಿ ತಂಡಕ್ಕೆ ಪಂದ್ಯ ಮತ್ತು ಲೀಗ್ ಅಂಕಗಳು ಸಿಗುತ್ತದೆ."
        ]
      },
      {
        title: "ಇನ್ನಿಂಗ್ಸ್ ಸಮಯ, ದಂಡ ಮತ್ತು ಟೈ",
        items: [
          "ಪ್ರತಿ ಇನ್ನಿಂಗ್ಸ್‌ಗೆ ನ್ಯಾಯಾಧೀಶರು ಅಳೆಯುವ ಆಟದ ಸಮಯ 40 ನಿಮಿಷಗಳು.",
          "40 ನಿಮಿಷ ಮೀರಿದರೆ ವಿಳಂಬಕ್ಕೆ ಕಾರಣವಾದ ತಂಡಕ್ಕೆ 5 ರನ್ ದಂಡ ಅಂಪೈರ್‌ಗಳ (Umpires) ನಿರ್ಧಾರ. ಬೌಲಿಂಗ್/ಫೀಲ್ಡಿಂಗ್ ವಿಳಂಬ — ಫೀಲ್ಡಿಂಗ್ ತಂಡ; ಬ್ಯಾಟಿಂಗ್ ವಿಳಂಬ — ಬ್ಯಾಟಿಂಗ್ ತಂಡ.",
          "ಸ್ಕೋರ್ ಸಮನಾಗಿದ್ದರೆ ಸೂಪರ್ ಓವರ್‌ನಿಂದ ವಿಜೇತ ನಿರ್ಧಾರ (ವಿಶೇಷ ಪಂದ್ಯಕ್ಕೆ ಸಮಿತಿ ಬೇರೆ tie-break ಹೇಳಿದರೆ ಅದು)."
        ]
      },

      {
        ...
        items: [
          "6 ತಂಡಗಳು, ರೌಂಡ್-ರಾಬಿನ್ ಲೀಗ್ — 15 ಲೀಗ್ ಪಂದ್ಯಗಳು. ವೇಳಾಪಟ್ಟಿಯ ಪ್ರಕಾರ 6, 8 ಅಥವಾ 10 ಓವರ್‌ಗಳು.",
          "ಲೀಗ್ ಅಂಕಗಳು: ಗೆಲುವು = 2, ಸೋಲು = 0. ಸಮ ಅಂಕಗಳಲ್ಲಿ net run rate (NRR) ಬಳಸಲಾಗುತ್ತದೆ.",
          "ಲೀಗ್ ಪಟ್ಟಿಯ ಮೊದಲ 4 ತಂಡಗಳು ಪ್ಲೇ-ಆಫ್‌ಗೆ: ಕ್ವಾಲಿಫೈಯರ್ 1, ಎಲಿಮಿನೇಟರ್, ಕ್ವಾಲಿಫೈಯರ್ 2, ಫೈನಲ್ (ಈ ಸೈಟ್‌ನ «ಪ್ಲೇ-ಆಫ್» ಟ್ಯಾಬ್ ನೋಡಿ).",
          "ಅತ್ಯುತ್ತಮ ಆಟಗಾರ (MVP) ಅಂಕಗಳು ಪ್ರತಿ ಪಂದ್ಯದ ಬ್ಯಾಟಿಂಗ್, ಬೌಲಿಂಗ್, ಫೀಲ್ಡಿಂಗ್‌ನಿಂದ ಸ್ವಯಂಚಾಲಿತ; «Statistics» ಪುಟದಲ್ಲಿ ಕ್ರಮ."
        ]
      }
    ]
  },
